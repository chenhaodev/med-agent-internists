...
# 背景章（结构/评估/辅助检查）——关键词从窄，避免抢占病种路由
KW_CARDIOLOGY_CV_STRUCTURE="心脏结构|心脏解剖|心脏正常功能|心脏.*怎么工作|心脏.*如何工作|心脏泵血|血管结构|心肌结构|心脏的正常|心脏.*正常结构"
KW_CARDIOLOGY_CV_ASSESSMENT="心血管.*评估|心脏病.*评估|心脏听诊|心脏杂音.*意义|心血管.*问诊|心脏病.*体格检查"
KW_CARDIOLOGY_CV_DIAGNOSTICS="心电图能查|心电图.*意义|超声心动图|心脏彩超|冠脉造影|冠状动脉造影|动态心电图|Holter|平板运动试验|心脏负荷试验|心脏CT|冠脉CT|心脏核磁|心脏磁共振|心肌核素|心导管检查"
...
KW_ENDOCRINE_MALE_REPRO="性腺功能减退|男性生殖.*内分泌|生殖内分泌|睾酮低|低睾酮|睾丸功能减退|男性激素.*低|男性不育.*内分泌|性腺功能低下"
...
# 背景章
KW_RESPIRATORY_LUNG_BASICS="肺的结构|肺的功能|肺如何工作|肺怎么工作|健康的肺|肺的正常|肺泡.*气体|气体交换|呼吸的原理|肺的工作"
KW_RESPIRATORY_RESP_ASSESSMENT="呼吸疾病.*评估|呼吸科.*检查思路|呼吸困难.*怎么查|咳嗽.*怎么检查|肺部.*检查思路|呼吸病.*诊治思路"
KW_RESPIRATORY_LUNG_FUNCTION="肺功能检查|肺功能测定|肺功能报告|做肺功能|肺活量|FEV1|FVC|弥散功能|支气管激发试验|支气管舒张试验|峰流速"
...
KW_DIGESTIVE_ACUTE_LIVER_FAILURE="急性肝衰竭|暴发性肝衰|急性肝功能衰竭|肝衰竭|急性肝功能损伤.*衰竭"
# 背景章（症状学/内镜影像/肝脏检验）
KW_DIGESTIVE_GI_SYMPTOMS="消化道症状|胃肠道症状|腹痛.*原因|腹胀.*原因|恶心呕吐.*原因|吞咽困难.*原因|消化道.*常见表现|消化系统.*症状"
KW_DIGESTIVE_GI_DIAGNOSTICS="胃镜|肠镜|结肠镜|内镜检查|消化道造影|钡餐|钡剂|胶囊内镜|超声内镜|腹部CT.*消化|做个胃肠镜|胃肠镜"
KW_DIGESTIVE_LIVER_LABS="转氨酶.*解读|转氨酶.*意义|肝功能.*化验|肝功能化验单|肝功能.*指标.*意义|肝功能检查.*意义|肝酶.*意义|胆红素.*化验.*意义|看懂肝功能"
...
KW_RENAL_NON_GLOMERULAR="非肾小球|肾结石|肾囊肿|多囊肾|尿路梗阻|肾盂积水|肾积水|间质性肾炎|肾小管.*疾病|肾小管酸中毒|遗传性肾病|肾钙质沉着"
# 背景章
KW_RENAL_STRUCTURE="肾脏结构|肾脏解剖|肾的功能|肾的结构|肾单位|肾小球.*结构|肾脏如何工作|肾脏怎么工作|肾脏正常功能"
KW_RENAL_PATIENT="肾脏病.*评估|肾功能.*怎么查|肾脏检查项目|肾穿刺|肾活检|尿常规.*意义|尿检.*意义|肾病.*怎么查"
...
KW_HEMATOLOGY_NEUTROPHIL="中性粒细胞|粒细胞减少症|中性粒细胞增多|嗜中性粒细胞|粒细胞功能异常|白细胞增多.*中性"
# 背景章（造血/生理止血）
KW_HEMATOLOGY_HEMATOPOIESIS="造血|骨髓造血|造血干细胞|血细胞生成|造血功能|造血衰竭|血细胞是怎么"
KW_HEMATOLOGY_COAGULATION_BASICS="凝血功能|凝血机制|止血机制|生理止血|凝血过程|凝血指标|凝血检查|PT.*APTT|出凝血"
...
# 背景章（宿主防御/感染实验室诊断）
KW_INFECTIOUS_HOST_DEFENSE="宿主防御|宿主.*防御|人体如何抵抗|免疫系统.*感染|免疫力.*感染|抵抗力.*感染|免疫防御|身体怎么对抗.*感染|防御.*病原|如何.*抵抗.*感染|防御.*感染"
KW_INFECTIOUS_LAB_DIAGNOSIS="病原.*检测|病原学检查|病原体检测|细菌培养|血培养|药敏试验|革兰染色|感染.*化验|核酸检测.*感染|感染.*实验室"
...
KW_RHEUMATOLOGY_SJOGRENS="干燥综合征|口干.*眼干|眼干.*口干|口眼干燥|口干眼干|眼睛干.*口干|系统性疾病.*风湿样|结缔组织病.*表现"
KW_RHEUMATOLOGY_SOFT_TISSUE="纤维肌痛|肌筋膜|肌腱炎|腱鞘炎|滑囊炎|网球肘|肩周炎|非关节.*疼痛|软组织.*疼痛|软组织风湿"
KW_RHEUMATOLOGY_ASSESSMENT="风湿病.*评估|风湿病.*处理|关节痛.*怎么查|风湿.*检查思路|自身抗体.*意义|风湿免疫.*检查|风湿病.*诊治思路"

# 分子医学（背景章，科普级别）
KW_MOLECULAR="基因突变|遗传病|遗传方式|基因检测|遗传咨询|染色体异常|显性遗传|隐性遗传|X连锁|家族遗传|致病基因|遗传倾向|分子基础"
...
check "cardiology:cv_diagnostics"  "$KW_CARDIOLOGY_CV_DIAGNOSTICS"
check "cardiology:cv_assessment"   "$KW_CARDIOLOGY_CV_ASSESSMENT"
check "cardiology:cv_structure"    "$KW_CARDIOLOGY_CV_STRUCTURE"
...
check "endocrine:male_repro_endo"  "$KW_ENDOCRINE_MALE_REPRO"
...
check "respiratory:lung_function"  "$KW_RESPIRATORY_LUNG_FUNCTION"
check "respiratory:resp_assessment" "$KW_RESPIRATORY_RESP_ASSESSMENT"
check "respiratory:lung_basics"    "$KW_RESPIRATORY_LUNG_BASICS"
...
check "digestive:acute_liver_failure" "$KW_DIGESTIVE_ACUTE_LIVER_FAILURE"
check "digestive:liver_labs"       "$KW_DIGESTIVE_LIVER_LABS"
check "digestive:gi_diagnostics"   "$KW_DIGESTIVE_GI_DIAGNOSTICS"
check "digestive:gi_symptoms"      "$KW_DIGESTIVE_GI_SYMPTOMS"
...
check "renal:non_glomerular"       "$KW_RENAL_NON_GLOMERULAR"
check "renal:renal_structure"      "$KW_RENAL_STRUCTURE"
check "renal:renal_patient"        "$KW_RENAL_PATIENT"
...
check "hematology:neutrophil"      "$KW_HEMATOLOGY_NEUTROPHIL"
check "hematology:hematopoiesis"   "$KW_HEMATOLOGY_HEMATOPOIESIS"
check "hematology:coagulation_basics" "$KW_HEMATOLOGY_COAGULATION_BASICS"
...
check "infectious:host_defense"    "$KW_INFECTIOUS_HOST_DEFENSE"
check "infectious:infect_lab_diagnosis" "$KW_INFECTIOUS_LAB_DIAGNOSIS"
...
check "rheumatology:sjogrens"      "$KW_RHEUMATOLOGY_SJOGRENS"
check "rheumatology:soft_tissue"   "$KW_RHEUMATOLOGY_SOFT_TISSUE"
check "rheumatology:rheum_assessment" "$KW_RHEUMATOLOGY_ASSESSMENT"

# 分子医学（背景章）
check "molecular:molecular_basis"  "$KW_MOLECULAR"
