...
`覆盖全书 126 章` · `18 个专科` · `评测 38.7 / 40` · `答案可溯源到页码` · `Python + Bash`
...
**覆盖度 / 准确性 / 安全性 / 溯源**。目标线是平均 **≥ 85%（即 34/40）**。

| 模式 | 题数 | 通过率 | 覆盖 | 准确 | 安全 | 溯源 | 总分 |
|------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **患者问答（最近一轮）** | 21 | **95.2%** | 9.2 | 9.6 | 9.8 | **10.0** | **38.7 / 40** ✓ |

> 近期多轮（患者 + 医生）评测通过率落在 **91.7% – 100%** 区间，总分均稳定越过 34/40 目标线。
